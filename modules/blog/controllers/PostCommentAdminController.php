...
use app\modules\blog\searches\PostCommentSearch;
use Yii;
...
/**
 * PostCommentAdminController implements the CRUD actions for PostComment model.
 */
class PostCommentAdminController extends Controller
{
    /**
     * {@inheritdoc}
     */
